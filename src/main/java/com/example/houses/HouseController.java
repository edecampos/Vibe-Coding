...
public class HouseController {
    ...
    public String getCheapestHousesAsTable(
        ...
        sb.append(".results-table th, .results-table td { padding:16px 22px; text-align:left; border-bottom:1px solid #eee; font-size:1.09rem; word-break:break-word; white-space:nowrap; }");
