...
public class HomeController {
    ...
    public String home() {
        // PNG logo that works reliably for both img and background
        ...
        return "<html>" +
            ...
            "<style>" +
            // Cognizant blue gradient and watermark logo
            "body{font-family:'Segoe UI',Arial,sans-serif;" +
            "background:linear-gradient(120deg,#0057b7 0%,#3eb6e7 100%);" +
            "margin:0;padding:0;min-height:100vh;" +
            "position:relative;}" +
            // Watermark logo in backdrop
            "body::before{" +
            "content:'';" +
            "position:fixed;" +
            "z-index:0;" +
            ...
            ".notice{background:#e6f0fa;color:#0057b7;border-left:7px solid #3eb6e7;box-shadow:0 2px 10px #0057b710;padding:1em 1.5em;margin-bottom:2em;border-radius:10px;font-size:1.12em;display:flex;align-items:center;gap:14px;}" +
            ...
            "<div class='container'>" +
            "<div class='logo-row'>" +
            "<img class='logo-img' src='" + logoUrl + "' alt='Cognizant Logo'/>" +
